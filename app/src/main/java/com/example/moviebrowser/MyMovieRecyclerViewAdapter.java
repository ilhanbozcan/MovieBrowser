 ...
 * specified {@link OnMovieSelectionListener}.
...
public class MyMovieRecyclerViewAdapter extends
    ...
    private final OnMovieSelectionListener mListener;
    int selectedIndex;

    public MyMovieRecyclerViewAdapter(List<Movie> items, OnMovieSelectionListener listener) {
